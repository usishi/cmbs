!function($, wysi) {
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            var self = this;
            var insertImageModal = $('#selectImage');
            var urlInput = insertImageModal.find('#medianamelist');
            ...
            var insertImage = function() {
                ...
                self.editor.composer.commands.exec("insertImage",{src:url,style:"float:left;margin:10;"});
